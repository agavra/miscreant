// Vendored from SlateDB `src/cached_object_store/storage.rs` (Apache-2.0). See
// the module comment in `mod.rs` for provenance. Verbatim except for this note.

use async_trait::async_trait;
use bytes::Bytes;
use object_store::{Attribute, Attributes, ObjectMeta, path::Path};
